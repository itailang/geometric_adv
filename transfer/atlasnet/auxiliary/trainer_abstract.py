...
import transfer.atlasnet.auxiliary.visualization as visualization
import transfer.atlasnet.auxiliary.meter as meter


class TrainerAbstract(object):
    """
    This class implements an abstract deep learning trainer. It is supposed to be generic for any data, task, architecture, loss...
    It defines the usual generic functions.
