...
# add paths
parent_dir = osp.dirname(osp.dirname(osp.dirname(osp.dirname(osp.dirname(osp.abspath(__file__))))))
if parent_dir not in sys.path:
    sys.path.append(parent_dir)

# import modules
import transfer.atlasnet.auxiliary.netvision.ChartGenerator as ChartGenerator
import transfer.atlasnet.auxiliary.netvision.MeshGenerator as MeshGenerator
from transfer.atlasnet.auxiliary.netvision.MeshGenerator import Mesh
import transfer.atlasnet.auxiliary.netvision.Table as Table
import transfer.atlasnet.auxiliary.netvision.ConfusionMatrixGenerator as ConfusionMatrixGenerator
