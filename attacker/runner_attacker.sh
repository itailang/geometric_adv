...
#######################
# run the attack
python run_attack.py --loss_dist_type chamfer --loss_adv_type chamfer --dist_weight_list 1.0 --num_pc_for_attack 25 \
...
#######################
# run the attack
python run_attack.py --loss_dist_type chamfer --loss_adv_type latent --dist_weight_list 150.0 --num_pc_for_attack 25 \
