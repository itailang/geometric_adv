...
class AutoEncoder(NeuralNet):
    ...
    def get_loss(self, X, GT=None):
        if GT is None:
            ...
            assert self.is_denoising is True,\
                'When GT is not None, self.is_denoising should be True in order to have separate placeholder for self.gt'
